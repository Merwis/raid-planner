...
<div>
	<table
		class="table table-bordered table-hover table-striped table-autowidth">
		<tr>
			<th>Povolání</th>
			<td><c:out value="${myCharacter.charClass}" /></td>
		</tr>
		<tr>
			<th>Rasa</th>
			<td><c:out value="${myCharacter.race}" /></td>
		</tr>
		<tr>
			<th>Level</th>
			<td><c:out value="${myCharacter.level}" /></td>
		</tr>
	</table>
